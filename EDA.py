...
for i in range(1000):
    output1 = t.synonym_replacement(train_data[0][i])
#     print(output1)
    output2 = t.random_insertion(train_data[0][i])
    output3 = t.random_swap(train_data[0][i])
    output = t.random_deletion(train_data[0][i], p=0.2)